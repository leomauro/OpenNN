...
void PerformanceTermTest::test_calculate_interlayers_Delta(void)
{
    ...
    interlayers_combination_combination_Jacobian = nn.get_multilayer_perceptron_pointer()
                                                     ->calculate_interlayers_combination_combination_Jacobian(inputs);

    layers_delta = mpt.calculate_layers_delta(layers_activation_derivative, output_gradient);
    interlayers_Delta = mpt.calculate_interlayers_Delta(layers_activation_derivative,
...
//   size_t parameters_number;
    ...
    second_order_forward_propagation = nn.get_multilayer_perceptron_pointer()
    ...
    perceptrons_combination_parameters_gradient = nn.get_multilayer_perceptron_pointer()
