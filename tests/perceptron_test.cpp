...
void PerceptronTest::test_calculate_combination_parameters_Hessian(void)
{
    ...
    numerical_combination_parameters_Hessian = nd.calculate_Hessian(p,
                                                                    &Perceptron::calculate_combination,
                                                                    inputs,
                                                                    parameters);
    ...
    assert_true((combination_parameters_Hessian - numerical_combination_parameters_Hessian).calculate_absolute_value() < 1.0e-3,
                LOG);
}
...
void PerceptronTest::test_calculate_activation_second_derivative(void)
{
    ...
    activation_numerical_second_derivative = nd.calculate_second_derivative(p,
                                                                            &Perceptron::calculate_activation,
                                                                            combination);
