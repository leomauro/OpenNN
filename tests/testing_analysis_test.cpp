...
void TestingAnalysisTest::test_calculate_true_positive_instances(void)
{
    ...
    true_positive_instances = ta.calculate_true_positive_instances(target_data,
                                                                   output_data,
                                                                   testing_indices,
                                                                   threshold);
...
void TestingAnalysisTest::test_calculate_false_positive_instances(void)
{
    ...
    false_positive_instances = ta.calculate_false_positive_instances(target_data,
                                                                     output_data,
                                                                     testing_indices,
                                                                     threshold);
...
void TestingAnalysisTest::test_calculate_false_negative_instances(void)
{
    ...
    false_negative_instances = ta.calculate_false_negative_instances(target_data,
                                                                     output_data,
                                                                     testing_indices,
                                                                     threshold);
...
void TestingAnalysisTest::test_calculate_true_negative_instances(void)
{
    ...
    true_negative_instances = ta.calculate_true_negative_instances(target_data,
                                                                   output_data,
                                                                   testing_indices,
                                                                   threshold);
...
void TestingAnalysisTest::test_calculate_multiple_classification_rates(void)
{
    ...
    Matrix<Vector<size_t> > multiple_classification_rates = ta.calculate_multiple_classification_rates(target_data,
                                                                                                       output_data,
                                                                                                       testing_indices);
