...
const double &LevenbergMarquardtAlgorithm::get_minimum_performance_increase() const
{
...
const double &LevenbergMarquardtAlgorithm::get_performance_goal() const
{
...
const size_t &LevenbergMarquardtAlgorithm::get_maximum_selection_performance_decreases() const
{
...
const bool &LevenbergMarquardtAlgorithm::get_reserve_performance_history() const
{
...
const bool &LevenbergMarquardtAlgorithm::get_reserve_selection_performance_history() const
{
...
Vector<double> LevenbergMarquardtAlgorithm::calculate_gradient(const Vector<double> &terms,
...
std::string LevenbergMarquardtAlgorithm::LevenbergMarquardtAlgorithmResults::to_string() const
{
    std::ostringstream buffer;
...
std::string LevenbergMarquardtAlgorithm::write_training_algorithm_type() const
{
    return "LEVENBERG_MARQUARDT_ALGORITHM";
}

// the most representative
Matrix<std::string> LevenbergMarquardtAlgorithm::to_string_matrix() const
{
    std::ostringstream buffer;
...
void LevenbergMarquardtAlgorithm::testCUDA(double *terms,
                                           double *terms_Jacobian,
                                           double *Jacobian_dot_Jacobian,
                                           double *gradient,
                                           double *gradient_norm,
                                           const int n,
                                           const int m)
{
    ...
    gradientJacobianDotJacobian(terms_Jacobian_device,
                                terms_device,
                                Jacobian_dot_Jacobian_device,
                                gradient_device,
                                Jacobian_dot_Jacobian,
                                gradient,
                                gradient_norm,
                                m,
                                n);
