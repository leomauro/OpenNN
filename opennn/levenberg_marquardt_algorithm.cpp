...
/// @param document TinyXML document containint the object data.
    ...
    void LevenbergMarquardtAlgorithm::from_XML(const tinyxml2::XMLDocument &document)
    {
        ...
        const tinyxml2::XMLElement *minimum_damping_parameter_element = root_element->FirstChildElement(
        ...
        const tinyxml2::XMLElement *maximum_damping_parameter_element = root_element->FirstChildElement(
        ...
        const tinyxml2::XMLElement *damping_parameter_factor_element = root_element->FirstChildElement(
...
/// Uses Eigen to solve the system of equations by means of the Householder QR decomposition.
    ...
    Vector<double> LevenbergMarquardtAlgorithm::perform_Householder_QR_decomposition(const Matrix<double> &A,
