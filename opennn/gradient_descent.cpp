...
const double &GradientDescent::get_minimum_performance_increase() const
{
...
const double &GradientDescent::get_performance_goal() const
{
...
const size_t &GradientDescent::get_maximum_selection_performance_decreases() const
{
...
const bool &GradientDescent::get_reserve_performance_history() const
{
...
const bool &GradientDescent::get_reserve_selection_performance_history() const
{
...
std::string GradientDescent::GradientDescentResults::to_string() const
{
    std::ostringstream buffer;
...
std::string GradientDescent::write_training_algorithm_type() const
{
    return "GRADIENT_DESCENT";
}

// the most representative
Matrix<std::string> GradientDescent::to_string_matrix() const
{
    std::ostringstream buffer;
