...
public:
    ...
    // Get methods
    const SolutionsErrorMethod &get_solutions_error_method() const;

    std::string write_solutions_error_method() const;

    const Vector<double> &get_solutions_errors_weights() const;
    ...
    // Constraints methods
    double calculate_solutions_error_sum() const;

    double calculate_solutions_error_integral() const;

    virtual double calculate_performance() const;
