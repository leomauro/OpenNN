...
/// @todo Check that the method i
    ...
    void MissingValues::from_XML(const tinyxml2::XMLDocument &document)
    {
        ...
        const tinyxml2::XMLElement *instances_number_element = missing_values_element->FirstChildElement(
                "InstancesNumber");
        ...
        const tinyxml2::XMLElement *variables_number_element = missing_values_element->FirstChildElement(
                "VariablesNumber");
        ...
        const tinyxml2::XMLElement *scrubbing_method_element = missing_values_element->FirstChildElement(
                "ScrubbingMethod");
        ...
        const tinyxml2::XMLElement *missing_values_number_element = missing_values_element->FirstChildElement(
                "MissingValuesNumber");
