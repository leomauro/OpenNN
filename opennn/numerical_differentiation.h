...
/// In particular it implements the forward and central differences methods for derivatives, Jacobians, Hessians or Hessian forms.
    ...
    public:
        ...
        enum NumericalDifferentiationMethod {
            ForwardDifferences, CentralDifferences
        };
        ...
        template<class T>
        double calculate_forward_differences_derivative(const T &t,
        ...
        template<class T>
        double calculate_central_differences_derivative(const T &t,
                                                        double (T::*f)(const double &) const,
                                                        const double &x) const
        {
            const double h = calculate_h(x);
        ...
        template<class T>
        Vector<double> calculate_forward_differences_derivative(const T &t,
                                                                Vector<double> (T::*f)(const Vector<double> &) const,
        ...
        template<class T>
        Vector<double> calculate_central_differences_derivative(const T &t,
                                                                Vector<double> (T::*f)(const Vector<double> &) const,
                                                                const Vector<double> &x) const
        {
            const Vector<double> h = calculate_h(x);
        ...
        template<class T>
        Vector<double> calculate_derivative(const T &t,
                                            Vector<double> (T::*f)(const Vector<double> &) const,
                                            const Vector<double> &x) const
        {
            switch (numerical_differentiation_method) {
        ...
        template<class T>
        Vector<double> calculate_forward_differences_derivative(const T &t,
                                                                Vector<double> (T::*f)(const size_t &,
        ...
        template<class T>
        Vector<double> calculate_derivative(const T &t,
                                            Vector<double> (T::*f)(const size_t &, const Vector<double> &) const,
                                            const size_t &dummy,
                                            const Vector<double> &x) const
        {
            switch (numerical_differentiation_method) {
        ...
        template<class T>
        double calculate_forward_differences_second_derivative(const T &t,
                                                               double (T::*f)(const double &) const,
                                                               const double &x) const
        {
            const double h = calculate_h(x);
        ...
        template<class T>
        double calculate_central_differences_second_derivative(const T &t,
                                                               double (T::*f)(const double &) const,
                                                               const double &x) const
        {
            const double h = calculate_h(x);
            ...
            const double d2 = (-y_forward_2 + 16.0 * y_forward - 30.0 * y + 16.0 * y_backward - y_backward_2) / (12.0 * pow(
                    h,
                    2));
        ...
        template<class T>
        Vector<double> calculate_forward_differences_second_derivative(const T &t,
                                                                       Vector<double> (T::*f)(const Vector<double> &) const,
                                                                       const Vector<double> &x) const
        {
            const Vector<double> y = (t.*f)(x);
        ...
        template<class T>
        Vector<double> calculate_central_differences_second_derivative(const T &t,
                                                                       Vector<double> (T::*f)(const Vector<double> &) const,
                                                                       const Vector<double> &x) const
        {
            const Vector<double> h = calculate_h(x);
        ...
        template<class T>
        Matrix<double> calculate_forward_differences_second_derivative(const T &t,
                                                                       double (T::*f)(const size_t &,
                                                                                      const Vector<double> &,
                                                                                      const size_t &,
                                                                                      const Vector<double> &) const,
                                                                       const size_t &dummy_1,
                                                                       const Vector<double> &x1,
                                                                       const size_t &dummy_2,
                                                                       const Vector<double> &x2) const
        {
        ...
        template<class T>
        Vector<double> calculate_forward_differences_gradient(const T &t,
        ...
        template<class T>
        Vector<double> calculate_central_differences_gradient(const T &t,
                                                              double (T::*f)(const Vector<double> &) const,
                                                              const Vector<double> &x) const
        {
            const size_t n = x.size();
        ...
        template<class T>
        Vector<double> calculate_gradient(const T &t,
                                          double (T::*f)(const size_t &, const Vector<double> &) const,
                                          const size_t &dummy,
                                          const Vector<double> &x) const
        {
            switch (numerical_differentiation_method) {
        ...
        template<class T>
        Matrix<double> calculate_forward_differences_Hessian(const T &t,
                                                             double (T::*f)(const Vector<double> &) const,
                                                             const Vector<double> &x) const
        {
            size_t n = x.size();
        ...
        template<class T>
        Matrix<double> calculate_central_differences_Hessian(const T &t,
                                                             double (T::*f)(const Vector<double> &) const,
                                                             const Vector<double> &x) const
        {
            size_t n = x.size();
            ...
            for (size_t i = 0; i < n; i++) {
                ...
                H(i,
                  i) = (-y_forward_2i + 16.0 * y_forward_i - 30.0 * y + 16.0 * y_backward_i - y_backward_2i) / (12.0 * pow(
                        h_i,
                        2));
                ...
                for (size_t j = i; j < n; j++) {
                    ...
                    H(i,
                      j) = (y_forward_ij - y_forward_i_backward_j - y_backward_i_forward_j + y_backward_ij) / (4.0 * h_i * h_j);
                }
            }
        ...
        template<class T>
        Matrix<double> calculate_forward_differences_Jacobian(const T &t,
                                                              Vector<double> (T::*f)(const Vector<double> &) const,
                                                              const Vector<double> &x) const
        {
        ...
        template<class T>
        Matrix<double> calculate_central_differences_Jacobian(const T &t,
                                                              Vector<double> (T::*f)(const Vector<double> &) const,
                                                              const Vector<double> &x) const
        {
            Vector<double> y = (t.*f)(x);
        ...
        template<class T>
        Matrix<double> calculate_Jacobian(const T &t,
                                          Vector<double> (T::*f)(const Vector<double> &) const,
                                          const Vector<double> &x) const
        {
            switch (numerical_differentiation_method) {
        ...
        template<class T>
        Matrix<double> calculate_forward_differences_Jacobian(const T &t,
                                                              Vector<double> (T::*f)(const Vector<double> &,
                                                                                     const Vector<double> &) const,
                                                              const Vector<double> &dummy,
                                                              const Vector<double> &x) const
        {
        ...
        Matrix<double> calculate_forward_differences_Jacobian
                (const T &t,
                 Vector<double> (T::*f)(const size_t &, const Vector<double> &, const Vector<double> &) const,
        ...
        Matrix<double> calculate_forward_differences_Jacobian
                (const T &t,
                 Vector<double> (T::*f)(const size_t &, const size_t &, const Vector<double> &) const,
        ...
        template<class T>
        Vector<Matrix<double> > calculate_forward_differences_Hessian_form(const T &t,
                                                                           Vector<double> (T::*f)(const Vector<double> &) const,
                                                                           const Vector<double> &x) const
        {
            Vector<double> y = (t.*f)(x);
        ...
        template<class T>
        Vector<Matrix<double> > calculate_central_differences_Hessian_form(const T &t,
                                                                           Vector<double> (T::*f)(const Vector<double> &) const,
                                                                           const Vector<double> &x) const
        {
            Vector<double> y = (t.*f)(x);
            ...
            for (size_t i = 0; i < s; i++) {
                ...
                for (size_t j = 0; j < n; j++) {
                    ...
                    H[i](j,
                         j) = (-y_forward_2j[i] + 16.0 * y_forward_j[i] - 30.0 * y[i] + 16.0 * y_backward_j[i] - y_backward_2j[i]) / (12.0 * pow(
                            h_j,
                            2));
                    ...
                    for (size_t k = j; k < n; k++) {
                        ...
                        H[i](j,
                             k) = (y_forward_jk[i] - y_forward_j_backward_k[i] - y_backward_j_forward_k[i] + y_backward_jk[i]) / (4.0 * h_j * h_k);
                    }
                }
        ...
        template<class T>
        Vector<Matrix<double> > calculate_Hessian_form(const T &t,
                                                       Vector<double> (T::*f)(const Vector<double> &) const,
                                                       const Vector<double> &x) const
        {
            switch (numerical_differentiation_method) {
