...
{
    return probabilistic_neurons_number == other_probabilistic_layer.probabilistic_neurons_number &&
           probabilistic_method == other_probabilistic_layer.probabilistic_method &&
           decision_threshold == other_probabilistic_layer.decision_threshold &&
           display == other_probabilistic_layer.display;
}
...
std::string ProbabilisticLayer::write_probabilistic_method() const
{
    if (probabilistic_method == Binary)
        ...
        buffer << "OpenNN Exception: ProbabilisticLayer class.\n"
               << "std::string write_probabilistic_method() const method.\n"
...
std::string ProbabilisticLayer::write_probabilistic_method_text() const
{
    if (probabilistic_method == Binary)
        return "binary";
    else if (probabilistic_method == Probability)
        ...
        buffer << "OpenNN Exception: ProbabilisticLayer class.\n"
               << "std::string write_probabilistic_method_text() const method.\n"
               << "Unknown probabilistic method.\n";
...
Vector<double> ProbabilisticLayer::calculate_binary_output(const Vector<double> &inputs) const
{
    ...
    outputs[0] = inputs[0] < decision_threshold? 0.0: 1.0;
    return outputs;
}
...
std::string ProbabilisticLayer::to_string() const
{
    std::ostringstream buffer;
...
std::string ProbabilisticLayer::write_binary_expression(const Vector<std::string> &inputs_names,
...
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.
std::string ProbabilisticLayer::write_probability_expression(const Vector<std::string> &inputs_names,
                                                             const Vector<std::string> &outputs_names) const
{
    std::ostringstream buffer;
...
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.
std::string ProbabilisticLayer::write_competitive_expression(const Vector<std::string> &inputs_names,
                                                             const Vector<std::string> &outputs_names) const
{
    std::ostringstream buffer;
...
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.
std::string ProbabilisticLayer::write_softmax_expression(const Vector<std::string> &inputs_names,
                                                         const Vector<std::string> &outputs_names) const
{
    std::ostringstream buffer;
...
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.
std::string ProbabilisticLayer::write_no_probabilistic_expression(const Vector<std::string> &inputs_names,
                                                                  const Vector<std::string> &outputs_names) const
{
    std::ostringstream buffer;
...
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.
std::string ProbabilisticLayer::write_expression(const Vector<std::string> &inputs_names,
                                                 const Vector<std::string> &outputs_names) const
{
    switch (probabilistic_method) {
    case Binary:
