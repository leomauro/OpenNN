...
double NormalizedSquaredError::calculate_normalization_coefficient(const Matrix<double> &target_data,
...
Vector<double> NormalizedSquaredError::calculate_output_gradient(const Vector<double> &output,
...
reduction(+ : normalization_coefficient)
    ...
    for (i = 0; i < (int) training_instances_number; i++) {
        ...
        first_order_forward_propagation = multilayer_perceptron_pointer->calculate_first_order_forward_propagation(
                                              inputs);
        ...
        layers_combination_parameters_Jacobian = multilayer_perceptron_pointer->calculate_layers_combination_parameters_Jacobian(
                    layers_inputs);
...
Matrix<double> NormalizedSquaredError::calculate_output_Hessian(const Vector<double> &,
        const Vector<double> &target) const
{
    const Vector<double> training_target_data_mean = data_set_pointer->calculate_training_target_data_mean();
...
Matrix<double> NormalizedSquaredError::calculate_Hessian(void) const
{
    ...
    for (size_t i = 0; i < training_instances_number; i++) {
        ...
        second_order_forward_propagation = multilayer_perceptron_pointer->calculate_second_order_forward_propagation(
                                               inputs);
        ...
        perceptrons_combination_parameters_gradient = multilayer_perceptron_pointer->calculate_perceptrons_combination_parameters_gradient(
                    layers_inputs);

        interlayers_combination_combination_Jacobian = multilayer_perceptron_pointer->calculate_interlayers_combination_combination_Jacobian(
                    inputs);
