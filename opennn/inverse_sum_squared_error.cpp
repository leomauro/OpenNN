...
InverseSumSquaredError::InverseSumSquaredError() : PerformanceTerm()
{
...
const InverseSumSquaredError::UnknownsMethod &InverseSumSquaredError::get_unknowns_method() const
{
...
std::string InverseSumSquaredError::write_unknowns_method() const
{
    ...
    default:
        {
            ...
            buffer << "OpenNN Exception: InverseSumSquaredError class.\n"
                   << "std::string write_unknowns_method() const method.\n"
...
/// <li> Display: true.
/// </ul>
void InverseSumSquaredError::set_default()
{
...
void InverseSumSquaredError::check() const
{
...
/// @todo
double InverseSumSquaredError::calculate_performance() const
{
    ...
    // Mathematical model stuff
    const Matrix<double> training_solution_data = mathematical_model_pointer->calculate_dependent_variables(*neural_network_pointer,
                                                                                                            training_input_data);
...
/// @todo
double InverseSumSquaredError::calculate_selection_performance() const
{
...
std::string InverseSumSquaredError::write_performance_term_type() const
{
...
tinyxml2::XMLDocument *InverseSumSquaredError::to_XML() const
{
    std::ostringstream buffer;
