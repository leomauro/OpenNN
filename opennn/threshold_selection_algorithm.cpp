...
std::string ThresholdSelectionAlgorithm::ThresholdSelectionResults::write_stopping_condition() const
{
...
std::string ThresholdSelectionAlgorithm::ThresholdSelectionResults::to_string() const
{
    std::ostringstream buffer;
