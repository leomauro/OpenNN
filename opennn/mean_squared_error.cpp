...
MeanSquaredError::MeanSquaredError() : PerformanceTerm()
{
}
...
double MeanSquaredError::calculate_performance() const
{
...
/// data set.
double MeanSquaredError::calculate_selection_performance() const
{
...
/// @todo
Matrix<double> MeanSquaredError::calculate_Hessian() const
{
...
/// @todo
PerformanceTerm::FirstOrderPerformance MeanSquaredError::calculate_first_order_performance() const
{
...
/// @todo
PerformanceTerm::SecondOrderPerformance MeanSquaredError::calculate_second_order_performance() const
{
...
std::string MeanSquaredError::write_performance_term_type() const
{
