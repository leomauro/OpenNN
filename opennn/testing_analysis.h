...
public:
    ...
    Matrix<size_t> calculate_confusion_multiple_classification(const Matrix<double> &,
    ...
    Vector<size_t> calculate_false_positive_instances(const Matrix<double> &,
                                                      const Matrix<double> &,
                                                      const Vector<size_t> &,
                                                      const double &) const;

    Vector<size_t> calculate_false_negative_instances(const Matrix<double> &,
                                                      const Matrix<double> &,
                                                      const Vector<size_t> &,
                                                      const double &) const;

    Vector<size_t> calculate_true_negative_instances(const Matrix<double> &,
                                                     const Matrix<double> &,
                                                     const Vector<size_t> &,
                                                     const double &) const;
