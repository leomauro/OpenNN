                              ...
                              const Vector<Vector<std::string> > &nominal_labels)
    {
        ...
        for (size_t i = 0; i < nominal_labels.size(); i++) {
            if (nominal_labels[i].size() == 0) {
                ...
                if (nominal_labels[i].contains("true") || nominal_labels[i].contains("True") || nominal_labels[i].contains(
                        "TRUE")) {
                    names.push_back(columns_name[i] + "_true");
                }
                else if (nominal_labels[i].contains("positive") || nominal_labels[i].contains("Positive") || nominal_labels[i]
                        .contains("POSITIVE")) {
