...
double NeuralParametersNorm::calculate_performance() const
{
    ...
    return neural_parameters_norm_weight * neural_network_pointer->get_multilayer_perceptron_pointer()
                                                                 ->arrange_parameters().calculate_norm();
}
...
Vector<double> NeuralParametersNorm::calculate_gradient() const
{
    ...
    return neural_network_pointer->get_multilayer_perceptron_pointer()
                                 ->arrange_parameters().calculate_norm_gradient() * neural_parameters_norm_weight;
}
...
Matrix<double> NeuralParametersNorm::calculate_Hessian() const
{
    ...
    return neural_network_pointer->get_multilayer_perceptron_pointer()
                                 ->arrange_parameters().calculate_norm_Hessian() * neural_parameters_norm_weight;
}
...
double NeuralParametersNorm::calculate_performance(const Vector<double> &parameters) const
{
    ...
    if (neural_network_pointer->has_independent_parameters()) {
        const size_t neural_parameters_number = neural_network_pointer->get_multilayer_perceptron_pointer()
        ...
        return parameters.calculate_norm() * neural_parameters_norm_weight;
}
...
std::string NeuralParametersNorm::write_performance_term_type() const
{
    return "NEURAL_PARAMETERS_NORM";
}

std::string NeuralParametersNorm::write_information() const
{
    std::ostringstream buffer;
