...
std::string EvolutionaryAlgorithm::write_fitness_assignment_method() const
{
    ...
    default:
        {
            ...
            buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
                   << "std::string write_fitness_assignment_method() const method.\n"
...
std::string EvolutionaryAlgorithm::write_selection_method() const
{
    ...
    default:
        {
            ...
            buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
                   << "std::string write_selection_method() const method.\n"
...
std::string EvolutionaryAlgorithm::write_recombination_method() const
{
    ...
    default:
        {
            ...
            buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
                   << "std::string write_recombination_method() const method.\n"
...
std::string EvolutionaryAlgorithm::write_mutation_method() const
{
    ...
    default:
        {
            ...
            buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
                   << "std::string get_mutation_method_name() const method.\n"
...
const Vector<double> &EvolutionaryAlgorithm::get_performance() const
{
    return performance;
}
...
const double &EvolutionaryAlgorithm::get_best_performance_goal() const
{
    return best_performance_goal;
}

/// Returns the maximum number of selection failures during the training process.
const size_t &EvolutionaryAlgorithm::get_maximum_selection_performance_decreases() const
{
...
const bool &EvolutionaryAlgorithm::get_reserve_selection_performance_history() const
{
...
const bool &EvolutionaryAlgorithm::get_reserve_mean_performance_history() const
{
...
/// and false otherwise.
const bool &EvolutionaryAlgorithm::get_reserve_standard_deviation_performance_history() const
{
...
const bool &EvolutionaryAlgorithm::get_reserve_best_performance_history() const
{
...
void EvolutionaryAlgorithm::set_reserve_standard_deviation_performance_history(const bool &new_reserve_standard_deviation_performance_history)
{
...
double EvolutionaryAlgorithm::calculate_mean_performance() const
{
    return performance.calculate_mean();
}

/// Returns the standard deviation value of the individuals performance.
double EvolutionaryAlgorithm::calculate_standard_deviation_performance() const
{
...
const double &EvolutionaryAlgorithm::get_mean_performance_goal() const
{
    return mean_performance_goal;
}

/// Returns the standard deviation of the performance at which training will stop.
const double &EvolutionaryAlgorithm::get_standard_deviation_performance_goal() const
{
...
void EvolutionaryAlgorithm::set_fitness_assignment_method(const EvolutionaryAlgorithm::FitnessAssignmentMethod &new_fitness_assignment_method)
{
...
void EvolutionaryAlgorithm::set_recombination_method(const EvolutionaryAlgorithm::RecombinationMethod &new_recombination_method)
{
...
void EvolutionaryAlgorithm::randomize_population_uniform(const Vector<double> &minimum,
...
std::string EvolutionaryAlgorithm::EvolutionaryAlgorithmResults::to_string() const
{
    std::ostringstream buffer;
...
EvolutionaryAlgorithm::EvolutionaryAlgorithmResults *EvolutionaryAlgorithm::perform_training()
{
    ...
    for (size_t generation = 0; generation <= maximum_generations_number; generation++) {
        ...
        if (display && generation % display_period == 0) {
...
std::string EvolutionaryAlgorithm::write_training_algorithm_type() const
{
    return "EVOLUTIONARY_ALGORITHM";
}

// the most representative
Matrix<std::string> EvolutionaryAlgorithm::to_string_matrix() const
{
    std::ostringstream buffer;
