...
PerformanceFunctional::PerformanceFunctional(void)
    : neural_network_pointer(NULL), data_set_pointer(NULL), mathematical_model_pointer(NULL),
      sum_squared_error_objective_pointer(NULL), mean_squared_error_objective_pointer(NULL),
      root_mean_squared_error_objective_pointer(NULL), normalized_squared_error_objective_pointer(NULL),
      Minkowski_error_objective_pointer(NULL), cross_entropy_error_objective_pointer(NULL),
      weighted_squared_error_objective_pointer(NULL), roc_area_error_objective_pointer(NULL),
      outputs_integrals_objective_pointer(NULL), solutions_error_objective_pointer(NULL),
      final_solutions_error_objective_pointer(NULL), independent_parameters_error_objective_pointer(NULL),
      inverse_sum_squared_error_objective_pointer(NULL), user_objective_pointer(NULL),
      neural_parameters_norm_regularization_pointer(NULL), outputs_integrals_regularization_pointer(NULL),
      user_regularization_pointer(NULL), outputs_integrals_constraints_pointer(NULL),
      solutions_error_constraints_pointer(NULL), final_solutions_error_constraints_pointer(NULL),
      independent_parameters_error_constraints_pointer(NULL), user_constraints_pointer(NULL)
{
...
PerformanceFunctional::PerformanceFunctional(NeuralNetwork *new_neural_network_pointer)
    : neural_network_pointer(new_neural_network_pointer), data_set_pointer(NULL),
      mathematical_model_pointer(NULL), sum_squared_error_objective_pointer(NULL),
      mean_squared_error_objective_pointer(NULL), root_mean_squared_error_objective_pointer(NULL),
      normalized_squared_error_objective_pointer(NULL), Minkowski_error_objective_pointer(NULL),
      cross_entropy_error_objective_pointer(NULL), weighted_squared_error_objective_pointer(NULL),
      roc_area_error_objective_pointer(NULL), outputs_integrals_objective_pointer(NULL),
      solutions_error_objective_pointer(NULL), final_solutions_error_objective_pointer(NULL),
      independent_parameters_error_objective_pointer(NULL), inverse_sum_squared_error_objective_pointer(NULL),
      user_objective_pointer(NULL), neural_parameters_norm_regularization_pointer(NULL),
      outputs_integrals_regularization_pointer(NULL), user_regularization_pointer(NULL),
      outputs_integrals_constraints_pointer(NULL), solutions_error_constraints_pointer(NULL),
      final_solutions_error_constraints_pointer(NULL), independent_parameters_error_constraints_pointer(NULL),
...
PerformanceFunctional::PerformanceFunctional(NeuralNetwork *new_neural_network_pointer,
    ...
    : neural_network_pointer(new_neural_network_pointer), data_set_pointer(new_data_set_pointer),
      mathematical_model_pointer(NULL), sum_squared_error_objective_pointer(NULL),
      mean_squared_error_objective_pointer(NULL), root_mean_squared_error_objective_pointer(NULL),
      normalized_squared_error_objective_pointer(NULL), Minkowski_error_objective_pointer(NULL),
      cross_entropy_error_objective_pointer(NULL), weighted_squared_error_objective_pointer(NULL),
...
PerformanceFunctional::PerformanceFunctional(NeuralNetwork *new_neural_network_pointer,
    ...
    : neural_network_pointer(new_neural_network_pointer), data_set_pointer(NULL),
      mathematical_model_pointer(new_mathematical_model_pointer), sum_squared_error_objective_pointer(NULL),
      mean_squared_error_objective_pointer(NULL), root_mean_squared_error_objective_pointer(NULL),
      normalized_squared_error_objective_pointer(NULL), Minkowski_error_objective_pointer(NULL),
      cross_entropy_error_objective_pointer(NULL), weighted_squared_error_objective_pointer(NULL),
      roc_area_error_objective_pointer(NULL), outputs_integrals_objective_pointer(NULL),
...
PerformanceFunctional::PerformanceFunctional(PerformanceTerm *new_user_objective_pointer)
    : neural_network_pointer(NULL), data_set_pointer(NULL), mathematical_model_pointer(NULL),
      ...
      outputs_integrals_objective_pointer(NULL), solutions_error_objective_pointer(NULL),
      final_solutions_error_objective_pointer(NULL), independent_parameters_error_objective_pointer(NULL),
      inverse_sum_squared_error_objective_pointer(NULL), user_objective_pointer(new_user_objective_pointer),
      neural_parameters_norm_regularization_pointer(NULL), outputs_integrals_regularization_pointer(NULL),
      user_regularization_pointer(NULL), outputs_integrals_constraints_pointer(NULL),
      solutions_error_constraints_pointer(NULL), final_solutions_error_constraints_pointer(NULL),
      independent_parameters_error_constraints_pointer(NULL), user_constraints_pointer(NULL)
      ...
      independent_parameters_error_constraints_pointer(NULL), user_constraints_pointer(NULL)
{
    ...
    case INDEPENDENT_PARAMETERS_ERROR_OBJECTIVE: {
        independent_parameters_error_objective_pointer = new IndependentParametersError(*other_performance_functional
    ...
    case INDEPENDENT_PARAMETERS_ERROR_CONSTRAINTS: {
        independent_parameters_error_constraints_pointer = new IndependentParametersError(*other_performance_functional
...
bool PerformanceFunctional::has_selection(void) const
{
    if (!data_set_pointer) {
        ...
        const size_t selection_instances_number = data_set_pointer->get_instances()
                .count_selection_instances_number();
...
void PerformanceFunctional::set_mathematical_model_pointer(MathematicalModel *new_mathematical_model_pointer)
{
    ...
    case INDEPENDENT_PARAMETERS_ERROR_OBJECTIVE: {
        independent_parameters_error_objective_pointer->set_mathematical_model_pointer(
    ...
    case INDEPENDENT_PARAMETERS_ERROR_CONSTRAINTS: {
        independent_parameters_error_constraints_pointer->set_mathematical_model_pointer(
            new_mathematical_model_pointer);
    }
    break;
...
void PerformanceFunctional::set_objective_type(const ObjectiveType &new_objective_type)
{
    ...
    case ROOT_MEAN_SQUARED_ERROR_OBJECTIVE: {
        root_mean_squared_error_objective_pointer = new RootMeanSquaredError(neural_network_pointer,
                data_set_pointer);
    }
    break;

    case NORMALIZED_SQUARED_ERROR_OBJECTIVE: {
        normalized_squared_error_objective_pointer = new NormalizedSquaredError(neural_network_pointer,
                data_set_pointer);
    }
    break;

    case WEIGHTED_SQUARED_ERROR_OBJECTIVE: {
        weighted_squared_error_objective_pointer = new WeightedSquaredError(neural_network_pointer,
                data_set_pointer);
    }
    break;
...
double PerformanceFunctional::calculate_performance(const Vector<double> &parameters) const
{
    ...
    return (calculate_objective(parameters) + calculate_regularization(parameters) + calculate_constraints(
                parameters));
}
...
Vector<double> PerformanceFunctional::calculate_gradient(const Vector<double> &parameters) const
{
    ...
    return (calculate_objective_gradient(parameters) + calculate_regularization_gradient(parameters) + calculate_constraints_gradient(
                parameters));
}
...
Matrix<double> PerformanceFunctional::calculate_Hessian(const Vector<double> &parameters) const
{
    ...
    return (calculate_objective_Hessian(parameters) + calculate_regularization_Hessian(parameters) + calculate_constraints_Hessian(
                parameters));
}
...
double PerformanceFunctional::calculate_second_order_Taylor_approximation(const Vector<double> &parameters) const
{
    ...
    const double second_order_Taylor_approximation = performance
            ...
            + parameters_difference.dot(Hessian)
            .dot(parameters_difference) / 2.0;
...
tinyxml2::XMLDocument *PerformanceFunctional::to_XML(void) const
{
    ...
    case SUM_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *sum_squared_error_element = sum_squared_error_document->FirstChildElement(
                    "SumSquaredError");
    ...
    case MEAN_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *mean_squared_error_element = mean_squared_error_document->FirstChildElement(
                    "MeanSquaredError");
    ...
    case ROOT_MEAN_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *root_mean_squared_error_element = root_mean_squared_error_document->FirstChildElement(
    ...
    case NORMALIZED_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLDocument *normalized_squared_error_document = normalized_squared_error_objective_pointer
                ->to_XML();

        const tinyxml2::XMLElement *normalized_squared_error_element = normalized_squared_error_document->FirstChildElement(
    ...
    case WEIGHTED_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *weighted_squared_error_element = weighted_squared_error_document->FirstChildElement(
    ...
    case MINKOWSKI_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *Minkowski_error_element = Minkowski_error_document->FirstChildElement(
                    "MinkowskiError");
    ...
    case CROSS_ENTROPY_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *cross_entropy_error_element = cross_entropy_error_document->FirstChildElement(
                    "CrossEntropyError");
    ...
    case OUTPUTS_INTEGRALS_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *outputs_integrals_element = outputs_integrals_document->FirstChildElement(
                    "OutputsIntegrals");
    ...
    case SOLUTIONS_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *solutions_error_element = solutions_error_document->FirstChildElement(
                    "SolutionsError");
    ...
    case FINAL_SOLUTIONS_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLElement *final_solutions_error_element = final_solutions_error_document->FirstChildElement(
                    "FinalSolutionsError");
    ...
    case INDEPENDENT_PARAMETERS_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLDocument *independent_parameters_error_document = independent_parameters_error_objective_pointer
                ->to_XML();

        const tinyxml2::XMLElement *independent_parameters_error_element = independent_parameters_error_document->FirstChildElement(
    ...
    case INVERSE_SUM_SQUARED_ERROR_OBJECTIVE: {
        ...
        const tinyxml2::XMLDocument *inverse_sum_squared_error_document = inverse_sum_squared_error_objective_pointer
                ->to_XML();

        const tinyxml2::XMLElement *inverse_sum_squared_error_element = inverse_sum_squared_error_document->FirstChildElement(
    ...
    case NEURAL_PARAMETERS_NORM_REGULARIZATION: {
        ...
        const tinyxml2::XMLDocument *neural_parameters_norm_document = neural_parameters_norm_regularization_pointer
                ->to_XML();

        const tinyxml2::XMLElement *neural_parameters_norm_element = neural_parameters_norm_document->FirstChildElement(
    ...
    case INDEPENDENT_PARAMETERS_ERROR_CONSTRAINTS: {
        ...
        const tinyxml2::XMLDocument *independent_parameters_error_document = independent_parameters_error_constraints_pointer
                ->to_XML();
...
void PerformanceFunctional::from_XML(const tinyxml2::XMLDocument &document)
{
    ...
    const tinyxml2::XMLElement *regularization_element = performance_functional_element->FirstChildElement(
                "Regularization");
    ...
    if (regularization_element) {
        ...
        const tinyxml2::XMLElement *constraints_element = performance_functional_element->FirstChildElement(
                    "Constraints");
