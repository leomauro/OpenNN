...
{
    return parameters == other_independent_parameters.parameters &&
           names == other_independent_parameters.names &&
           units == other_independent_parameters.units &&
           descriptions == other_independent_parameters.descriptions &&
           minimums == other_independent_parameters.minimums &&
...
const Vector<std::string> &IndependentParameters::get_names() const
{
    return names;
}
...
const Vector<std::string> &IndependentParameters::get_units() const
{
    return units;
}
...
const Vector<std::string> &IndependentParameters::get_descriptions() const
{
    return descriptions;
}
...
/// </ul>
Vector<Vector<std::string>> IndependentParameters::arrange_information()
{
...
std::string IndependentParameters::write_scaling_method() const
{
...
std::string IndependentParameters::write_bounding_method() const
{
    if (bounding_method == NoBounding)
        ...
        buffer << "OpenNN Exception: IndependentParameters class.\n"
               << "std::string write_bounding_method() const method.\n"
...
void IndependentParameters::set_scaling_method(const IndependentParameters::ScalingMethod &new_scaling_method)
{
...
void IndependentParameters::set_bounding_method(const IndependentParameters::BoundingMethod &new_bounding_method)
{
...
void IndependentParameters::randomize_parameters_uniform(const Vector<double> &minimum,
...
void IndependentParameters::randomize_parameters_normal(const Vector<double> &mean,
...
std::string IndependentParameters::to_string() const
{
    std::ostringstream buffer;
