...
{
    return *neural_network_pointer == *other_independent_parameters_error.neural_network_pointer &&
           *mathematical_model_pointer == *other_independent_parameters_error.mathematical_model_pointer &&
           *numerical_differentiation_pointer == *other_independent_parameters_error.numerical_differentiation_pointer &&
           display == other_independent_parameters_error.display &&
           target_independent_parameters == other_independent_parameters_error.target_independent_parameters &&
...
const Vector<double> &IndependentParametersError::get_target_independent_parameters() const
{
...
const Vector<double> &IndependentParametersError::get_independent_parameters_errors_weights() const
{
...
void IndependentParametersError::set_target_independent_parameter(const size_t &i,
...
void IndependentParametersError::set_independent_parameter_error_weight(const size_t &i,
...
/// <li> Display: True.
/// </ul>
void IndependentParametersError::set_default()
{
...
void IndependentParametersError::check() const
{
    ...
    if (target_independent_parameters_size != independent_parameters_number) {
        ...
        buffer << "OpenNN Exception: IndependentParametersError class." << std::endl
               << "double calculate_performance() const method." << std::endl
...
double IndependentParametersError::calculate_performance() const
{
...
Vector<double> IndependentParametersError::calculate_gradient() const
{
...
Matrix<double> IndependentParametersError::calculate_Hessian() const
{
...
std::string IndependentParametersError::write_performance_term_type() const
{
    return "INDEPENDENT_PARAMETERS_ERROR";
}

std::string IndependentParametersError::write_information() const
{
    std::ostringstream buffer;
...
tinyxml2::XMLDocument *IndependentParametersError::to_XML() const
{
    std::ostringstream buffer;
